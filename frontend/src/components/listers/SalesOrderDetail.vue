<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <CompanyId offline label="Customer" v-model="item.customer" :editMode="false" :key="false" @change="change" />
            <div>
            ...
            <div>
                <String label="OrderManager" v-model="item.orderManager" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="AccountingYearMonth" v-model="item.accountingYearMonth" :editMode="editMode" @change="change" />
            </div>
            <UserId offline label="RegisteredBy" v-model="item.registeredBy" :editMode="false" :key="false" @change="change" />
            <div>
