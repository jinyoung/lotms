<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="휴대번호" v-model="value.phoneNumber" :editMode="editMode" :inputUI="'TEXT'"/>
            <Date label="입사일자" v-model="value.joinDate" :editMode="editMode" :inputUI="'TEXT'"/>
            <Boolean label="관리자 여부" v-model="value.isAdmin" :editMode="editMode" :inputUI="'SELECT'"/>
            <Boolean label="부서장 여부" v-model="value.isDeptManager" :editMode="editMode" :inputUI="'SELECT'"/>
        </v-card-text>
